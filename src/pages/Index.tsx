...
const Index = () => {
  return (
    <div className="pt-16 cursor-custom">
      ...
      {/* CTA Section */}
      <section className="bg-blue-900 text-white py-16 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/contact">
              <Button size="lg" className="bg-orange-500 hover:bg-orange-600 hover:scale-105 transform transition-all duration-300 shadow-lg hover:shadow-xl">
